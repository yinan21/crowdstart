        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="order-box">
                    ...
                    <p class="small-text text-muted float-right">Available Share: {{product.units}} %</p>
                    <br>
                    <hr>
                    <label class="row"><span class="col-md-2 float-left">Share to buy: </span><input type="number" name="units" min="1" :max="product.units" class="col-md-2 float-left" v-model="quantity" @change="checkUnits">%</label>
                </div>
                <br>
                <div>
                    <div v-if="!isLoggedIn">
